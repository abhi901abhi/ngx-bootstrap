...
describe('Component: timepicker', () => {
  ...
  xdescribe('default configuration', () => {
    ...
    fit('should set time in a input field after click on input change button', () => {
      expect(inputHours.value).toBeFalsy();
      expect(inputMinutes.value).toBeFalsy();
  ...
  xdescribe('hide change button', () => {
    beforeEach(() => {
      html = `<timepicker [(ngModel)]="myTime" [showSpinners]="showSpinners"></timepicker>`;
    ...
    it('should hide change button', () => {
      ...
      fixture.whenStable()
        .then(() => {
          console.log('component.showSpinners', component.showSpinners);
        ...
        .then(() => {
          buttonChanges = getElements(fixture.nativeElement, 'a.btn');
          console.log('buttonChangess', buttonChanges);
          expect(buttonChanges).toBeFalsy();
        });
    });
  });
